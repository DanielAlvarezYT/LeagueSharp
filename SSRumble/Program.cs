...
namespace SSRumble
{
    internal class SSRumbleInit
    {
        ...
        private void GameOnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("<font color='#800040'>[SurvivorSeries] Rumble</font> <font color='#ff6600'>Loaded.</font>");
        ...
        private void BubbKushGo(Obj_AI_Hero target)
        {
            var posChecked = 0;
        ...
        private void LaneClear()
        {
            ...
            if ((minioncache != null) && (minioncache.Count > 0))
            {
                ...
                if ((selectedminion == null) || !selectedminion.IsValidTarget())
                    return;
                if (UseE && E.Instance.IsReady() && Player.IsWindingUp && selectedminion.IsValidTarget(E.Range) &&
